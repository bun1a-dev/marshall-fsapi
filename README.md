...
This integration uses FSAPI to communicate with the Marshall speaker.
...
You shouldn't worry about it — the default is `1234`.

## Thanks

* To me, for discovering the Marshall FSAPI protocol.
